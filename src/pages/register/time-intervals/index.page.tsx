...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine((intervals) => intervals.length > 0, {
      message: 'Selecione pelo menos 1 dia da semana!',
    })
    .transform((intervals) =>
    ...
    .refine(
      ...
      {
        message: 'O horário de início precisa ser antes do horário de término',
      },
    )
    .refine(
      (intervals) =>
      ...
      {
        message: 'Os intervalos precisam ser de pelo menos 1h',
      },
    ),
})
